...
> **2026-08-17 정체일수 재확인**(`node scripts/check-trust-freshness.mjs`): 아래 표의 정체일수만 최신값으로 갱신. 별점·라이선스 등 나머지 항목은 전체 재조회한 것은 아님(범위 밖).
...
| LaurieWired/GhidraMCP | 9,350 | Apache-2.0 | ⚠️420일 정체(2026-08-17 재확인) | 🟡조건부 | 비선호(bethington 우선) |
| OwenPawl/ghidra-re-skill | 86 | ❌무라이선스 | 활발 | 🔴제외(법적) | — |
| Yuyz0112/claude-code-reverse | 2,390 | ❌무라이선스 | ⚠️355일 정체(2026-08-17 재확인) | 🔴제외(법적) | — |
